...
Se ele responder com range, você ajusta sua expectativa pro topo do range. Se ele não responder, dê seu range de 20-30% de spread baseado em pesquisa real. Tudo o que acontece aqui é o aquecimento da [negociação da oferta de emprego](/artigos/como-negociar-oferta-de-emprego) — quando o número finalmente vira proposta, é lá que você tem o último espaço pra ajustar.

## Como pesquisar o número certo (em 20 minutos)

Sem pesquisa, qualquer número que você der é chute. Use **pelo menos 3 fontes** — uma só vai te enganar. (Se você é analista pleno em São Paulo, já compilamos as faixas reais por área: veja [pretensão salarial de analista pleno em SP](/artigos/pretensao-salarial-analista-pleno-sp).)
...
Sinaliza falta de senso de valor. Recrutador vai oferecer o piso do range automaticamente. Você acabou de deixar 15-20% na mesa. (Essa, aliás, é uma das frases que entram na lista de [o que NÃO falar em entrevista](/artigos/o-que-nao-falar-em-entrevista).)
...
USD/EUR pra Brasil distorce muito. Pesquise o range em **dólar/euro líquido** e converta com câmbio realista (não cotação do dia, média de 6 meses). Nunca aceite "câmbio fictício" da empresa. Saber o nível exato da vaga ajuda na conversão: confira a [diferença entre pleno, sênior e especialista](/artigos/diferenca-pleno-senior-especialista) pra não ancorar no patamar errado.
