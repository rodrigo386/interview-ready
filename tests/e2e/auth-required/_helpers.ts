...
// Experiment PRE-4: signup collects only name/email/password. CPF + endereço
// are collected at checkout (see useCheckoutFlow.tsx); billing e2e specs
// exercise those dialogs directly.
